                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          SvgPicture.asset('assets/icons/ic_edit_range.svg'),
                          const SizedBox(
                            width: 24,
                          )
                        ],
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('${editTargetRange[index].min.toString()}'+'~'+'${editTargetRange[index].max.toString()}'),
                              ],
                            ),
                          ),
                        ],
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      '${editTargetRange[index].min.toString()}'+'~'+'${editTargetRange[index].max.toString()}'),
                                ],
                              ),
                            ),
                          ),
