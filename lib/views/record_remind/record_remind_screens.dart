                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color: isToggled ? AppColors.AppColor1 : AppColors.AppColor2,
                                          ),
                                          child: Container(
                                            width: size,
                                            height: size,
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: AppTheme.hintText
                            .copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.AppColor2),
                      ),
                    ),
                  ),
                  const SizedBox(
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style:
                            AppTheme.hintText.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white),
                      ),
                    ),
                  ),
                ],
