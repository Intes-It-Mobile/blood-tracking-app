...
class GoalFarDialog extends StatefulWidget {
  const GoalFarDialog({super.key});

  @override
  State<GoalFarDialog> createState() => _GoalFarDialogState();
}

class _GoalFarDialogState extends State<GoalFarDialog> {
  int countDown = 5;
  Timer? timer;
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        Text(
                          "${AppLocalizations.of(context)!.getTranslate('goal_far_txt')}",
