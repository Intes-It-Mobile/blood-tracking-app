...
class BottomAppBarCum extends StatefulWidget {
  ...
  @override
  State createState() => _BottomAppBarCumState();
}

class _BottomAppBarCumState extends State<BottomAppBarCum> {
